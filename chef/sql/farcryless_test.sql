...
# ------------------------------------------------------------
#CREATE DATABASE `farcryless_test`;
USE `farcryless_test`;
...
VALUES
	('2014-01-02 18:23:29','farcry',NULL,'farcry_CLIENTUD','installation','active','[{\"timestamp\":\"January, 04 2014 01:56:17 +1100\",\"reason\":\"Incorrect password\"}]','2007-12-17 17:18:19',0,'farcry','E689D150-0C0C-923A-C05D110545136581',NULL,'farcry',NULL,'SysAdmin');
